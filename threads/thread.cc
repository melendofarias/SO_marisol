...
Thread::Thread(const char* threadName)
{
    ...
    status = JUST_CREATED;
    calljoin= false;
	priority=10;				//salvo que se indique lo contrario
							//el thread no tiene prioridad
//	hijos=0;
...
//	Puerto *portOwn=new Puerto("portown", cerrojo, condSend, condReceive);
//	portRoot= (currentThread->portOwn);

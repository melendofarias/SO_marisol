...
class Thread {
  ...
  public:
    ...
    void Join(Thread* t);				//espera a que finalice un proceso hijo t
											
	bool calljoin;						// indica si el thread va a esperar la finalizacion del hijo
	Puerto* portOwn;		//puerto del thread
//	Puerto* portRoot;		//puerto del padre
//	int hijos;				//cuenta la cantidad de hijos

	int priority;		//prioridad del thread
